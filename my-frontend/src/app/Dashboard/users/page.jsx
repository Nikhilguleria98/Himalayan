...
import { CalendarDays, CheckCircle2, Eye, IndianRupee, PackageCheck, Users } from "lucide-react";
                    ...
                    <TableRow key={user._id}>
                      <TableCell>
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          className="mt-2 flex items-center gap-1 text-teal-700 border-teal-600 hover:bg-teal-50"
