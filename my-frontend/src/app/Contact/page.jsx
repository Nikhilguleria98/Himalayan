...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/client/contact/send`, {
        method: "POST",
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className={`px-8 py-2 rounded-full text-white transition-colors ${
                    isSubmitting
                      ? "bg-[#0099cc]/60 cursor-not-allowed"
                      : "bg-[#0099cc] hover:bg-[#007aa3]"
                  }`}
                >
